    ...
    <div>
      ...
      >
        <div className="dialog_content">
          ...
          >
            <input type="checkbox" style={{ marginRight: "10px" }} /> Collect
            email addresses
          </div>
          <div className="dialog_row">
            <div className="dialog_row_in">
              <span
                style={{ fontSize: "13px", fontWeight: "500", width: "70px" }}
              >
                Send via
              </span>
            ...
            <div className="dialog_row_end">
              ...
              <AiFillTwitterSquare style={{ fontSize: "20px" }} />
            </div>
          </div>
          ...
          <div className="dialog_tab_panels">
            <TabPanel value={value} index={0}>
              ...
              >
                ...
                <TextField
                  ...
                  id="margin-none"
                  defaultValue="To"
                  style={{ fontSize: "12px", marginBottom: "55px" }}
                />
                <TextField
                  label="Subject"
                  id="margin-none"
                ...
                <TextField
                  ...
                  id="margin-none"
                  size="small"
                  defaultValue="I have invited you to fill the form"
            ...
            <TabPanel value={value} index={1}>
              ...
              >
                <div className="tab_text" style={{ marginBottom: "8px" }}>
                  Link
                </div>
          ...
          <div className="dialog_footer">
            ...
            >
              <BsPersonPlus style={{ fontSize: "20px", marginRight: "10px" }} />{" "}
              Add collaborators
            </div>

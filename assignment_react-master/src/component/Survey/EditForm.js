      ...
      <div className="question_form">
        ...
        <div className="section">
          <div className="question_title_section">
            <input className="question_form_top">
          ...
          <div className="question_boxes">
            <div className="add_question">
              <div className="add_question_top">
                ...
                >
                  <MenuItem value="90" className="menuitem">
                    {" "}
                  ...
                  <MenuItem value="40">
                    {" "}
                    <BackupIcon style={{ marginRight: "10px" }} /> File Upload
                  </MenuItem>
                  <MenuItem value="50">
                    {" "}
                    <LinearScaleIcon style={{ marginRight: "10px" }} /> Linear
                    Scale
                  </MenuItem>
                  <MenuItem value="60">
                    {" "}
                    <AppsIcon style={{ marginRight: "10px" }} /> Tick-box grid
                  </MenuItem>
                  ...
                  <MenuItem value="80">
                    {" "}
                    <ScheduleIcon style={{ marginRight: "10px" }} /> Time
                  </MenuItem>
                </Select>
              </div>

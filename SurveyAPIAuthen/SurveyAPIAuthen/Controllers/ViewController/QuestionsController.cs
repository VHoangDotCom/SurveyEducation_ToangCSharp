...
namespace SurveyAPIAuthen.Controllers.ViewController
{
    public class QuestionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,QuestionText,Required,QuestionType,SurveyID")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,QuestionText,Required,QuestionType,SurveyID")] Question question)
        {
            if (ModelState.IsValid)
            {
